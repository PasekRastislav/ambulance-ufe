...
import { RpasekAmbulanceWlEditor } from '../rpasek-ambulance-wl-editor';
...
describe('rpasek-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [RpasekAmbulanceWlEditor],
      html: `<rpasek-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></rpasek-ambulance-wl-editor>`,
    });
