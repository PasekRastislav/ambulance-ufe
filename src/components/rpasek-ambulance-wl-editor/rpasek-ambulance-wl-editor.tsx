...
@Component({
  tag: 'rpasek-ambulance-wl-editor',
  styleUrl: 'rpasek-ambulance-wl-editor.css',
  shadow: true,
})
export class RpasekAmbulanceWlEditor {
  @Prop() entryId: string;
      ...
      <Host>
        <form ref={el => this.formElement = el}>
          ...
          <md-filled-text-field label="Čakáte od" disabled
            value={new Date(this.entry?.waitingSince || Date.now()).toLocaleTimeString()}>            <md-icon slot="leading-icon">watch_later</md-icon>
          </md-filled-text-field>
